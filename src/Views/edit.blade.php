                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" name="parent" id="optionsRadios1" value="common"
                                                       @if(old('parent') == 'common' or $chartType->parent == 'common') checked=""
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" name="parent" id="optionsRadios2" value="national"
                                                       @if(old('parent') == 'national'  or $chartType->parent == 'national') checked=""
                                                       @endif onchange="typeChanged()" class="optionsRadios">
                                                National
                                            </label>
                                        </div>
                                ...
                                <div class="form-group" id="country"
                                     @if(old('parent') == 'national' or $chartType->parent == 'national')
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="country" id="country">
                                            ...
                                            @foreach($all as $key=>$country)
                                                ...
                                                @if (old('country'))
                                                    {{ old('country') == $country ? 'selected="selected"' : '' }}
                                                @else
                                                    {{ $chartType->country == $country ? 'selected="selected"' : '' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="title"
                                               ...
                                               value="{{ old('title') ? old('title') : $chartType->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="tag"
                                               ...
                                               value="{{ old('tag') ? old('tag') : $chartType->tag }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="description"
                                               placeholder="Name (only letters, digits, hyphen, apostrophe, space)"
                                               value="{{ old('description') ? old('description') : $chartType->description }}">
                                    </div>
                                </div>
